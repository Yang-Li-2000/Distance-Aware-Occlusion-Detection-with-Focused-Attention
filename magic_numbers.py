...
CUSTOM_TSET_SET = False
#small_test_annotation_file = 'small_valid_combined_custom.odgt'
...
RANDOMLY_SHIFT_GT_INTERSECTION_BOXES = False
RAND_INTER_LOC = 0
RAND_INTER_SCALE = 0.3

RANDOMLY_ADJUST_SIZES_OF_GT_INTERSECTION_BOXES = False
RAND_INTER_SIZE_LOC = 0
RAND_INTER_SIZE_SCALE = 0.1

DO_NOT_PREDICT_INTERSECTION_BOX_IF_NO_INTERSECTION = False